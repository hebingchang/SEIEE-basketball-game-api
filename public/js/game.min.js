...
function create() {
    ...
    current_best_text = game.add.text(90, 250, '', { font: 'Arial', fontSize: '20px', fill: '#000', align: 'center' });// 230, 450
    current_best_score_text = game.add.text(170, 366, '', { font: 'Arial', fontSize: '40px', fill: '#00e6e6', align: 'center' }); // 300, 500
    current_all_text = game.add.text(113, 335, '', { font: 'Arial', fontSize: '20px', fill: '#000', align: 'center' }); // 300, 500
